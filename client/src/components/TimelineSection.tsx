          ...
          <div className="space-y-12">
            {timelineEvents.map((item, index) => {
              ...
              return (
                ...
                >
                  {/* Timeline Dot */}
                  <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 w-4 h-4 bg-[#4e403b] rounded-full border-4 border-background shadow-warm z-10"></div>

                  {/* Event Card */}
                  <div
                    className={`w-full max-w-md ${isEven ? "pr-8" : "pl-8"}`}
                  >
                    <div
                      className={`bg-card border border-border rounded-xl p-6 shadow-soft hover-elegant ${
                    ...
                    >
                      ...
                      >
                        <div
                          className={`w-10 h-10 bg-[#4e403b]/10 rounded-full flex items-center justify-center ${
