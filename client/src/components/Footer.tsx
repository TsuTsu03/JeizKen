      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center space-y-8">
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 max-w-md mx-auto">
            ...
            <p className="text-xl font-display font-semibold text-[#ffffff]">
              #JeizWantsTheDy
            </p>
          </div>
          ...
          <div className="flex justify-center items-center space-x-4 py-6">
            ...
            <Heart className="w-6 h-6 text-zinc-300 animate-float" />
            <div className="w-16 h-px bg-zinc-300"></div>
          </div>
          ...
          <div className="max-w-2xl mx-auto">
            <p className="text-primary-foreground/80 leading-relaxed italic">
              We're grateful to have you as part of our story. You've made our
              journey more beautiful, and we can't wait to share our special day
              with you.
            </p>
          </div>
